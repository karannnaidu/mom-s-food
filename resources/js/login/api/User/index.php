...
<header id="home">
  <div class="row">
     ...
     <ul >
       ...
       <li><p  style="color: white; float: right; text-transform: uppercase; font:sans-serif;  ">USERNAME : <?php  echo $_SESSION["username"]; ?> </p></li>
     </ul>
  ...
  <nav>
   <div class="row">
     ...
     <ul class="main-nav js-main-nav">
       ...
       <li><a href="C:\xampp\htdocs\login" >Sign Up</a></li>
     </ul>
